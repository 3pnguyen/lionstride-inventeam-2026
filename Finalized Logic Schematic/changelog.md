# Finalized Logic Schematic chengelog:
...
* V3 - 4.1.2026: Simplified schematic by removing USB C circuit, one ESP, and battery circuit. One ESP will be designated to drive two matrices